...
The authors used a large language model to assist with implementation and
dependency checks, experiment re-runs, statistical analysis, the derivation
and verification of Proposition~2, contribution framing, consistency checks,
and language editing; the authors take full responsibility for verifying the
code, results, proofs, analyses, and final manuscript.

\noindent\textbf{Disclosure of interests.} The authors may be eligible for an
institutional publication award if this paper is accepted.
