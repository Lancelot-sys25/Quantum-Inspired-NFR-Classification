...
runner script. For anonymous review, it is
available through the \href{https://anonymous.4open.science/r/nfr-review-artifact-CE2D/}{anonymous artifact repository}.

\section*{Use of AI Tools}
The authors used a large language model to assist with implementation checks,
dependency diagnosis, experiment re-runs, statistical-script review,
consistency checks, and language editing. The authors independently reviewed
and rewrote the propositions, statistical interpretations, contribution
framing, and final text against the code, logs, and exported results, and take
